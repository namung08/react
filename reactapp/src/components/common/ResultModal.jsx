function ResultModal({title, content, callbackFn}){
    return (
        <div className={`fixed top-0 left-0 z-[1055] flex h-full w-full justify-center bg-black bg-opacity-20`}>
            <div className="absolute bg-white shadow opacity-100 w-1/4 rounded mt10 mb-10 px-6 min-w-[600px]">
                ...
                <div className="justify-end flex ">
                    <button 
                        ...
                        className="rounded bg-blue-500 mt-4 mb-4 px-6 pt-4 pb-4 text-lg text-white">Close Modal</button>
                </div>
            </div>
        </div>
    );
